...
# Nothing binds 3010 from a clean checkout today — the server entry point stops
# on a native module the install does not build (AGENTS.md, Known Gaps), so
# this command answers only against a server started some other way.
